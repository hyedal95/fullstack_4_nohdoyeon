...
git remote add orign https://github.com/hyedal95/wedding_.git
//리모트 삭제(remove orign)
git remote remove orign https://github.com/hyedal95/wedding_.git
//리모트 확인
git remote -v
orign   https://github.com/hyedal95/wedding_.git (fetch)
orign   https://github.com/hyedal95/wedding_.git (push)
...
<!-- 배포  저장소 -->
https://github.com/hyedal95/wedding_.git
<!-- 
배포주소 => 아이디.깃허브.io/리파이지토리이름
settinf =>pages =>main => save
=>1분 이상 기다리고 새로고침 그럼 아래 처럼 나옴 
-->
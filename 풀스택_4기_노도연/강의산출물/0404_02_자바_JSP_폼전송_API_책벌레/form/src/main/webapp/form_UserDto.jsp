...
<%
	...
	userdto.setUsertitle(usertitle);
	userdto.setUserBookName(userBookName);
	userdto.setUserDate1(userDate1);
	userdto.setUserDate2(userDate2);
